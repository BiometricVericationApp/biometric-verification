...
#define DETECTION_RANGE 50.0  // Numbers beyond this number will be ignored
#define TOLERANCE 5.0 // The distance between left and right for considering that you're at the center.
